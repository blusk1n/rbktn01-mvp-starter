...
class Form extends React.Component{
  ...
  submitdecrypt(e){
    ...
    data !== "" && axios.post("/decrypt",{data}).then(response=>this.setState({input:response.data,crypted:""}))
  }
  ...
  submitForm(e){
    ...
    data !== "" && axios.post("/input",{data}).then(response=>this.setState({crypted:response.data,input:""}))
